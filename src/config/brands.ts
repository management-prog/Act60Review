...
const brands: Record<string, BrandConfig> = {
  act60review: {
    ...
    gaId: process.env.NEXT_PUBLIC_GA_ID_ACT60REVIEW || 'G-WQW29Y4QPT',
    ...
    heroSubheadline: 'IRS Campaign 685 has assessed $287,000 average deficiencies against decree holders. Our AI scans your return against 200+ compliance rules and flags the exact errors that trigger audits.',
  ...
  decreecheck: {
    ...
    gaId: process.env.NEXT_PUBLIC_GA_ID_DECREECHECK || 'G-S2647Q9T7K',
    ...
    heroSubheadline: 'Three minutes. That\'s all it takes to find out if your return has the errors the IRS is hunting for. No phone calls, no waiting, no CPA required.',
  ...
  act60shield: {
    ...
    gaId: process.env.NEXT_PUBLIC_GA_ID_ACT60SHIELD || 'G-YFFS7XF7YC',
    ...
    heroSubheadline: 'The IRS has allocated $80M+ to Act 60 enforcement. Get the same audit-ready documentation package that Big 4 firms charge $25,000+ to prepare.',
